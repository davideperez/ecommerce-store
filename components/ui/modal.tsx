...
//?? Learn the cases when destructuring the props is not just writing the prop names, but doing something else, ie, setting a default.
const Modal: React.FC<ModalProps> = ({
	...
	return (
		/* ?? What is Fragment?? and what is 'as' exactly?  */ 
